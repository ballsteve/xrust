...
#[test]
fn xpath_navigate_predicate_1() {
    xpathgeneric::generic_navigate_predicate_1::<RNode, _, _>(smite::make_empty_doc, smite::make_sd)
        .expect("test failed")
}
#[test]
...
#[test]
fn xpath_ns_1() {
    xpathgeneric::generic_ns_1::<RNode, _, _>(smite::make_empty_doc, smite::make_sd)
        .expect("test failed")
}
