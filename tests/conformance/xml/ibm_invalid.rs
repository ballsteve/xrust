...
fn ibminvalid_p28ibm28i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P28/ibm28i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p32ibm32i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P32/ibm32i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p32ibm32i03xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P32/ibm32i03.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p32ibm32i04xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P32/ibm32i04.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p39ibm39i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P39/ibm39i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p39ibm39i02xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P39/ibm39i02.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p39ibm39i03xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P39/ibm39i03.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p39ibm39i04xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P39/ibm39i04.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p41ibm41i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P41/ibm41i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p41ibm41i02xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P41/ibm41i02.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p45ibm45i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P45/ibm45i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p49ibm49i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P49/ibm49i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p50ibm50i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P50/ibm50i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p51ibm51i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P51/ibm51i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p51ibm51i03xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P51/ibm51i03.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i02xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i02.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i03xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i03.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i05xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i05.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i06xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i06.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i07xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i07.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i08xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i08.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i09xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i09.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i10xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i10.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i11xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i11.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i12xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i12.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i13xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i13.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i14xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i14.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i15xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i15.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i16xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i16.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i17xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i17.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p56ibm56i18xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P56/ibm56i18.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p58ibm58i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P58/ibm58i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p58ibm58i02xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P58/ibm58i02.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p59ibm59i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P59/ibm59i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p60ibm60i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P60/ibm60i01.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p60ibm60i02xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P60/ibm60i02.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p60ibm60i03xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P60/ibm60i03.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p60ibm60i04xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P60/ibm60i04.xml")
            .unwrap()
            .as_str());
}
...
fn ibminvalid_p76ibm76i01xml() {
    ...
    */
    ...
    test_ibm_invalid(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P76/ibm76i01.xml")
            .unwrap()
            .as_str());
}
