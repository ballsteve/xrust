...
fn ibmnotwf_p69ibm69n05xml() {
    ...
    */
    ...
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/not-wf/P69/ibm69n05.xml")
        .unwrap()
        .as_str(),
...
fn ibminvalid_p68ibm68i01xml() {
    ...
    */
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P68/ibm68i01.xml")
                       .unwrap()
                       .as_str(),
...
fn ibminvalid_p68ibm68i02xml() {
    ...
    */
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P68/ibm68i02.xml")
                       .unwrap()
                       .as_str(),
                   "tests/conformance/xml/xmlconf/ibm/invalid/P68/"
    );
...
fn ibminvalid_p68ibm68i03xml() {
    ...
    */
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P68/ibm68i03.xml")
                       .unwrap()
                       .as_str(),
                   "tests/conformance/xml/xmlconf/ibm/invalid/P68/"
    );
...
fn ibminvalid_p68ibm68i04xml() {
    ...
    */
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P68/ibm68i04.xml")
                       .unwrap()
                       .as_str(),
                   "tests/conformance/xml/xmlconf/ibm/invalid/P68/"
    );
...
fn ibminvalid_p69ibm69i01xml() {
    ...
    */
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P69/ibm69i01.xml")
                       .unwrap()
                       .as_str(),
...
fn ibminvalid_p69ibm69i02xml() {
    ...
    */
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P69/ibm69i02.xml")
                       .unwrap()
                       .as_str(),
                   "tests/conformance/xml/xmlconf/ibm/invalid/P69/"
    );
...
fn ibminvalid_p69ibm69i03xml() {
    ...
    */
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P69/ibm69i03.xml")
                       .unwrap()
                       .as_str(),
                   "tests/conformance/xml/xmlconf/ibm/invalid/P69/"
    );
...
fn ibminvalid_p69ibm69i04xml() {
    ...
    */
    test_ibm_error(fs::read_to_string("tests/conformance/xml/xmlconf/ibm/invalid/P69/ibm69i04.xml")
                       .unwrap()
                       .as_str(),
                   "tests/conformance/xml/xmlconf/ibm/invalid/P69/"
    );
