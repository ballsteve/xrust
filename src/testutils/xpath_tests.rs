...
*/
	...
	fn xpath_int() {
	    ...
	    let rd = $x();
	    let s = x(&mut ContextBuilder::new()
		      .result_document(rd)
		      .build())
...
/*
	...
	#[test]
	fn xpath_comment() {
	    let x = parse::<$t>("1(::),(: a comment :)'abc', (: outer (: inner :) outer :) 2")
