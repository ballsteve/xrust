...
pub fn parse(
    ...
    let state: ParserState<Nullo> = ParserState::new(None, None, None, intern);
...
mod tests {
    ...
    fn unqualified_raw() {
        ...
        let qn = new(None, None, "foo", &mut intern)
    ...
    fn qualified_raw() {
        ...
        assert_eq!(
            intern.0[qn],
            "Q{http://example.org/whatsinaname/}foo"
        )
    }
    /*#[test]
    fn qualified_rc() {
