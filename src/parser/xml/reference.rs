        ...
        match e {
            ...
            Ok(((input1, state1), entitykey)) => {
                ...
                match entitykey.as_str(){
                    "amp" => Ok(((input1, state1), vec![NodeBuilder::new(NodeType::Text).value(Value::String("&".to_string())).build()])),
                    "gt" => Ok(((input1, state1), vec![NodeBuilder::new(NodeType::Text).value(Value::String(">".to_string())).build()])),
                    "lt" => Ok(((input1, state1), vec![NodeBuilder::new(NodeType::Text).value(Value::String("<".to_string())).build()])),
                    "quot" => Ok(((input1, state1), vec![NodeBuilder::new(NodeType::Text).value(Value::String("\"".to_string())).build()])),
                    "apos" => Ok(((input1, state1), vec![NodeBuilder::new(NodeType::Text).value(Value::String("'".to_string())).build()])),
                    _ => {
