...
pub struct NamespaceMap(HashMap<Option<String>, String>);
...
impl NamespaceMap {
    ...
    pub fn insert(&mut self, prefix: Option<String>, uri: String) -> Option<String> {
    ...
    pub fn iter(&self) -> Iter<Option<String>, String> {
        self.0.iter()
    }
}
